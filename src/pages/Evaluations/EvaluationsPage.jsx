  ...
  return (
    <div>
      ...
      <div style={styles.header}>
        <button style={styles.addBtn}>+ Tạo kỳ đánh giá</button>
      </div>
            ...
            <div key={cycle.id} style={styles.card}>
              ...
              <div style={styles.cardBody}>
                <div style={styles.infoRow}>
                  <span style={styles.infoLabel}>Kỳ đánh giá</span>
          ...
          <div style={styles.modal} onClick={e => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              <div>
                ...
                <span style={{
                  ...styles.badge,
                  background: (STATUS_COLORS[selected.status] || '#6b7280') + '15',
            ...
            <div style={styles.modalBody}>
              ...
              <div style={styles.actionRow}>
                {selected.status === 'draft' && (
                  <button style={styles.primaryBtn}>Mở kỳ đánh giá</button>
                )}
                {selected.status === 'open' && (
                  <button style={styles.warningBtn}>Đóng kỳ đánh giá</button>
                )}
                {selected.status === 'closed' && (
                  <button style={styles.primaryBtn}>Phê duyệt</button>
                )}
              </div>
            </div>
          </div>
...
const styles = {
  ...
  warningBtn: {
    padding: '10px 20px', background: '#fef3c7', color: '#d97706',
    border: '1px solid #fcd34d', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer',
  },
}